...
function(add_benchmark name)
    if(BUILD_BENCHMARKS)
        ...
        target_include_directories(
            ${name}
            PUBLIC ${GBENCHMARK_INCLUDE_DIRS}
                   ${REPO_ROOT}
                   ${EIGEN3_INCLUDE_DIRS}
        )
        add_custom_command(
            ...
            COMMAND
                ...
                "$<TARGET_FILE:${name}> --benchmark_out=bench_results/$<TARGET_PROPERTY:${name},NAME>.json"
                >> ${PROJECT_BINARY_DIR}/run_benchmarks && chmod +x
                ${PROJECT_BINARY_DIR}/run_benchmarks
        )
        add_custom_command(
            TARGET ${name}
            POST_BUILD
            COMMAND ${CMAKE_COMMAND} -E echo $<TARGET_FILE:${name}> >>
                    ${PROJECT_BINARY_DIR}/benchmark_list
        )
    endif()
endfunction()
